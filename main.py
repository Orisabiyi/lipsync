...
class App(customtkinter.CTk):
  def __init__(self):
    ...
    self.header_btn = customtkinter.CTkButton(master=self.header_frame, text='Generate Sync Video', fg_color=PRIMARY_COLOR_2, hover_color=PRIMARY_COLOR_3, text_color='#fff', font=('Open Sans', 15, 'bold'), corner_radius=20, command=generate)
    self.header_btn.pack(side='right', padx=20, ipadx=15, pady=20, ipady=10)
